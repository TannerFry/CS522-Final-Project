...
#Best Params: {'activation': 'tanh', 'hidden_layer_sizes': (20, 20, 20), 'learning_rate_init': 0.001, 'max_iter': 1000, 'solver': 'lbfgs'}





mlp = MLPClassifier(hidden_layer_sizes=(20, 20, 20), activation='tanh', learning_rate_init=0.001, solver='lbfgs', max_iter=1000)
